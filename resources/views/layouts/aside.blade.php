    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ request()->is('credits') ? 'active' : '' }}"
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ request()->is('rooms') ? 'active' : '' }}"
                ...
                <div class="menu-item">
                    ...
                    <a class="menu-link {{ request()->is('orders') ? 'active' : '' }}"
                        ...
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                            <span class="svg-icon svg-icon-2">
                                <i class="fas fa-solid fa-shopping-cart fa-fw"></i>
                            </span>
                        </span>
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ request()->is('request-rooms') ? 'active' : '' }}"
                        href="{{ route('request-rooms.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                            <span class="svg-icon svg-icon-2">
                                <i class="fas fa-solid fa-hotel fa-fw"></i>
                        ...
                        <span class="menu-title">Request Rooms</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
