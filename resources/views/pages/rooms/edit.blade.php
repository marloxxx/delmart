    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <form id="kt_ecommerce_edit_room_form" class="form d-flex flex-column flex-lg-row"
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                                    id="kt_ecommerce_edit_room_avatar">
                    ...
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <a href="{{ route('rooms.index') }}}" id="kt_ecommerce_edit_product_cancel"
                                class="btn btn-light me-5">Cancel</a>
                            <!--end::Button-->
                            <!--begin::Button-->
                            <button type="submit" id="kt_ecommerce_edit_room_submit" class="btn btn-primary"
...
@section('scripts')
    <script>
        ...
        const KTFormControls = function() {
            // Base elements
            const formEl = $('#kt_ecommerce_edit_room_form');

            const _initAvatar = function() {
                // init avatar
                const imageInputElement = document.querySelector("#kt_ecommerce_edit_room_avatar");
        ...
        // on submit form
        $(document).on('submit', '#kt_ecommerce_edit_room_form', function(e) {
            e.preventDefault();
