    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <form id="kt_ecommerce_add_credit_form" class="form d-flex flex-column flex-lg-row"
                    data-kt-redirect="{{ route('credits.index') }}" action="{{ route('credits.store') }}" method="POST">
                    <!--begin::Main column-->
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <a href="{{ route('credits.index') }}" id="kt_ecommerce_add_product_cancel"
...
@section('scripts')
    <script>
        ...
        const KTFormControls = function() {
            // Base elements
            const formEl = $('#kt_ecommerce_add_credit_form');
            return {
                onSubmit: function() {
        ...
        // on submit form
        $(document).on('submit', '#kt_ecommerce_add_credit_form', function(e) {
            e.preventDefault();
