                            ...
                            <tbody class="fw-semibold text-gray-600">
                                @foreach ($credits as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-check form-check-sm form-check-custom form-check-solid">
                                                <input class="form-check-input" type="checkbox" value={{ $item->id }}
                                                    data-kt-ecommerce-credit-filter="credit_id" />
                                            </div>
                                        </td>
                                        <!--end::Checkbox-->
                                        <!--begin::Provider=-->
                                        <td>
                                            <div class="d-flex">
                                                <div class="d-flex flex-column">
                                                    <!--begin::Title-->
                                                    <a href="{{ route('credits.edit', $item->id) }}"
                                                        class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1"
                                                        data-kt-ecommerce-credit-filter="credit_provider">{{ $item->provider }}</a>
                                                    <!--end::Title-->
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <div class="ms-5">
                                                    ...
                                                    <a href="{{ route('credits.edit', $item->id) }}"
                                                        class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1"
                                                        data-kt-ecommerce-credit-filter="credit_nominal">{{ $item->nominal }}</a>
                                                    <!--end::Title-->
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <!--begin::Price=-->
                                        <td>
                                            <span class="text-gray-800 fw-bolder d-block fs-5">Rp
...
@section('scripts')
    <script>
        "use strict";
        var KTAppEcommerceCredits = function() {
            var t, e, n = () => {
